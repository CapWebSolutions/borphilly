<?php
/*
Template Name: Expired Job Postings
*/
...
?>
				...
				?>
					...
					<?php
						...
						echo '<strong>&nbsp;&mdash;</strong> ' . rwmb_meta( $prefix . 'contact_email' ) . '</p>';
						
						echo '<p class="job-expired"><strong>Posting Expired:</strong> ' . rwmb_meta( $prefix . 'expiration_date' ) . '<br></p>';
